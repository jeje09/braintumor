  ...
  return (
    <div className="space-y-10 pb-16">
      ...
      <section className="space-y-4">
        <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-emerald-100 text-emerald-800 dark:bg-emerald-950 dark:text-emerald-300 text-sm font-bold">
      ...
      <section className="p-6 rounded-3xl bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900/50 space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm text-amber-900 dark:text-amber-200 leading-relaxed font-medium">
          ...
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-bold text-emerald-600 bg-emerald-50 dark:bg-emerald-950 px-3 py-1.5 rounded-full">
                  의학 증거: {item.evidence}
                </span>
              </div>
            ...
            <div className="pt-4 border-t border-slate-100 dark:border-slate-800/80 text-sm text-slate-600 dark:text-slate-400 font-bold leading-relaxed">
              ⚠️ 주의사항: {item.caution}
            </div>
          </div>
        ))}
