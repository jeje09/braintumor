...
const INITIAL_GBM_FAQS = [
  ...
  },
  {
    ...
    answer: "교모세포종은 재발 위험이 높은 종양입니다.\n표준치료(수술, 방사선치료, 항암화학요법) 후에도 많은 환자에서 시간이 지나면서 재발이 발생할 수 있습니다. 재발 시기는 개인에 따라 크게 다르며, 수개월 내 재발하는 경우도 있지만 1년 이상 또는 그보다 더 오랜 기간 재발 없이 지내는 경우도 있습니다. 따라서 정기적인 MRI 추적검사가 매우 중요합니다.\n\n[재발 시 치료]\n재발한 교모세포종의 치료는 종양의 위치와 크기, 이전 치료 내용, 환자의 전신 상태와 신경학적 기능 등을 종합적으로 고려하여 결정됩니다.\n\n• 재수술: 종양이 수술 가능한 위치에 있고 환자의 상태가 양호한 경우 재수술을 고려할 수 있습니다.\n• 아바스틴(성분명: 베바시주맙): 종양의 혈관 생성을 억제하는 표적치료제입니다. 재발성 교모세포종에서 뇌부종을 줄이고 신경학적 증상을 완화하며, 스테로이드 사용량을 줄이는 데 도움이 될 수 있습니다. 다만 현재까지는 전체 생존기간을 의미 있게 연장한다는 근거는 제한적입니다.\n• 항암화학요법: 로무스틴(CCNU)이나 PCV 요법 등이 환자의 상태와 이전 치료에 따라 고려될 수 있습니다.\n• 재방사선 치료: 이전 방사선치료 이후 충분한 시간이 경과했고, 치료 범위와 환자 상태가 적합한 경우 선택될 수 있습니다.\n• 임상시험: 재발성 교모세포종을 대상으로 다양한 신약과 치료법의 임상시험이 진행되고 있으며, 적합한 경우 참여를 고려할 수 있습니다.\n• BNCT(붕소중성자포획치료): 일부 의료기관에서 임상시험이 진행되고 있으며, 아직 표준치료로 확립된 단계는 아닙니다."
  },
  {
    id: 6,
...
const INITIAL_NUTRITION = [
  {
    ...
    icon: "🥦",
    category: "면역력 강화",
    benefit: "항산화 물질, 비타민, 미네랄, 식이섬유 풍부. 몸속 염증 감소 및 장내 유익균 먹이가 되어 장 건강 개선.",
    howToEat: "짙은 녹색 채소, 빨간색/주황색 채소 골고루 섭취. 샐러드, 녹즙, 채소수프 등 다양하게 활용",
    caution: "면역 저하 시 생채소(샐러드)보다는 익혀서(수프, 데침) 먹는 것이 안전함",
    evidence: "★★★★★",
    color: "emerald"
  },
  {
    ...
    icon: "🍲",
    category: "장 건강 & 면역",
    benefit: "장내 미생물 다양성 증가로 면역력 강화. 장 건강 회복에 도움을 줌.",
    howToEat: "청국장, 김치, 콩으로 만든 요거트. 특히 청국장이 나토보다 더 다양한 유익균 포함",
    caution: "면역 수치가 극도로 낮을 때는 멸균식 위주로 전문의 상담 후 섭취",
    evidence: "★★★★☆",
    color: "amber"
  },
  {
    ...
    icon: "🫘",
    category: "식물성 단백질",
    benefit: "필수적인 양질의 단백질 공급. 장 건강에도 도움을 주는 훌륭한 식품.",
    howToEat: "두부, 두유, 삶은 콩, 서리태, 대두 등 국내에서 쉽게 구할 수 있는 콩 식품 섭취",
    caution: "소화가 어려울 때는 두부나 무가당 두유 형태로 부드럽게 섭취",
    evidence: "★★★★★",
    color: "amber"
  },
  {
    ...
    name: "냉압착 들기름과 아마씨유",
    icon: "🍾",
    category: "좋은 지방 (오메가-3)",
    benefit: "식물성 오메가-3(ALA)가 풍부하여 건강 유지에 도움을 줌.",
    howToEat: "음식이 완성된 후 마지막에 드레싱처럼 살짝 뿌려 먹기",
    caution: "가열하면 좋은 지방이 손상되므로 볶거나 튀기는 조리용으로는 절대 사용 금지",
    evidence: "★★★★☆",
    color: "yellow"
  },
  {
    ...
    icon: "🍄",
    category: "면역세포 활성화",
    benefit: "베타글루칸이 풍부해 면역세포를 활성화하는 데 도움을 줌.",
    howToEat: "특별한 버섯보다 표고, 느타리, 새송이, 팽이버섯 등 평소 쉽게 구하는 버섯을 충분히 활용",
    caution: "생으로 먹지 말고 충분히 익혀서 섭취",
    evidence: "★★★★☆",
    color: "rose"
  },
  {
    ...
    icon: "🥜",
    category: "건강한 지방 & 단백질",
    benefit: "건강한 지방과 식물성 단백질 공급. 꾸준히 섭취 시 체력 유지에 좋음.",
    howToEat: "매일 하루 일정량 꾸준히 섭취. 오메가-3와 오메가-6 비율이 이상적인 '호두' 가장 추천",
    caution: "오래 방치되어 산패된 견과류(곰팡이독소 위험)는 절대 섭취 금지",
    evidence: "★★★★☆",
    color: "orange"
  },
  {
    ...
    icon: "🌿",
    category: "미네랄 & 식이섬유",
    benefit: "미네랄과 식이섬유가 풍부하며 면역력을 높임. 세계 장수 지역(블루존)의 주요 식단.",
    howToEat: "미역, 다시마, 김, 톳 등을 반찬이나 국으로 꾸준히 섭취",
    caution: "갑상선 질환 등 요오드 섭취 제한이 필요한 경우 주치의 상담 필수",
    evidence: "★★★★☆",
    color: "teal"
  },
  {
    ...
    icon: "🌾",
    category: "혈당 안정 & 영양",
    benefit: "영양소가 풍부하고 혈당을 천천히 올리며 식이섬유도 많음. 백미 대신 강력 추천.",
    howToEat: "현미보다 소화가 잘되고 영양 흡수율이 높은 '발아현미'가 체력 회복에 적합",
    caution: "소화 기능이 매우 떨어졌을 때는 일시적으로 흰쌀죽 섭취",
    evidence: "★★★★★",
    color: "amber"
  },
  {
    ...
    icon: "🐟",
    category: "안전 동물성 단백질",
    benefit: "대형 생선 대비 중금속 축적 위험이 적으면서 양질의 단백질을 공급.",
    howToEat: "멸치, 대구, 명태, 조기, 병어, 도다리 등 작은 생선을 양식보다 자연산으로 선택",
    caution: "면역 저하 시 생선회는 절대 금지 (기생충 및 세균 감염 위험). 반드시 익혀 먹을 것",
    evidence: "★★★★☆",
    color: "blue"
  },
  {
    ...
    icon: "🍋",
    category: "당분 조절",
    benefit: "과당 함량이 적어 혈당 스파이크를 줄이면서도 과일의 비타민을 안전하게 섭취.",
    howToEat: "레몬, 라임, 크랜베리 등 섭취. 과일 섭취 후 산책하거나 차를 함께 마시기",
    caution: "과당이 많은 과일(망고 등), 과일주스, 액상과당 음료는 좋지 않으므로 피할 것",
    evidence: "★★★☆☆",
    color: "yellow"
  }
];
