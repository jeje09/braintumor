...
const INITIAL_NUTRITION = [
  {
    ...
    caution: "항암 중 면역 저하 시 생채소(샐러드)보다는 익혀서(수프, 데침) 먹는 것이 안전함",
    evidence: "★★★★★",
    color: "emerald"
  },
  {
    ...
    icon: "🍲",
    category: "장 건강 & 면역",
    benefit: "장내 미생물 다양성 증가로 면역력 강화. 특히 항암 치료로 감소한 장내 세균 회복에 탁월.",
  ...
  },
  {
    ...
    icon: "🫘",
    category: "식물성 단백질",
    benefit: "항암 환자에게 필수적인 양질의 단백질 공급. 장 건강에도 도움을 주는 최고 식품.",
  ...
  },
  {
    ...
    benefit: "식물성 오메가-3(ALA)가 풍부하여 세포막을 건강하게 유지하는 데 탁월한 효과.",
  ...
  },
  {
    ...
    icon: "🍄",
    category: "면역세포 활성화",
    benefit: "베타글루칸이 풍부해 면역세포를 활성화하고 항암 효과를 증진시킨다는 다수 연구 보고.",
  ...
  },
  {
    ...
    icon: "🥜",
    category: "건강한 지방 & 단백질",
    benefit: "건강한 지방과 식물성 단백질 공급. 꾸준히 섭취한 그룹의 암 사망률 및 재발 위험 감소 연구 결과.",
  ...
  },
  {
    ...
    howToEat: "현미보다 소화가 잘되고 영양 흡수율이 높은 '발아현미'가 암 환자에게 가장 적합",
    caution: "항암 부작용으로 소화 기능이 매우 떨어졌을 때는 일시적으로 흰쌀죽 섭취",
    evidence: "★★★★★",
    color: "amber"
  },
  {
    ...
    caution: "생선회는 항암 중 절대 금지 (기생충 및 세균 감염 위험). 반드시 익혀 먹을 것",
    evidence: "★★★★☆",
    color: "blue"
  },
  {
    ...
    caution: "과당이 많은 과일(망고 등), 과일주스, 액상과당 음료는 암 환자에게 좋지 않으므로 피할 것",
    evidence: "★★★☆☆",
    color: "yellow"
  }
];
